  ...
  return (
    <header className="sticky top-0 bg-white">
      <div className="flex w-full p-6 items-center">
        ...
        <form className="flex flex-grow px-6 py-3 ml-10 mr-5 border-gray-200 rounded-full shadow-md max-w-3xl items-center">
          <input
            ref={searchInputRef}
        ...
        <Avatar
          className="ml-auto"
          url="http://www.connectingcouples.us/wp-content/uploads/2019/07/avatar-placeholder.png"
        />
      </div>
